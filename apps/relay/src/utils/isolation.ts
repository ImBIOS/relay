...
Available models:
- GLM-5 (default, for Coding Plan Max users)
- GLM-4.7
- GLM-4.5-Air
...
export function generateEnvFile(apiKey: string, baseUrl: string): string {
...
export function setupSessionFiles(
  ...
  fs.writeFileSync(envPath, generateEnvFile(apiKey, baseUrl));
